...
$db['web1'] = [
	'dsn'	=> '',
	'hostname' => env('database.web1.hostname'),
	'username' => env('database.web1.username'),
	'password' => env('database.web1.password'),
...
$db['master'] = [
	'dsn'	=> '',
	'hostname' => env('database.master.hostname'),
	'username' => env('database.master.username'),
	'password' => env('database.master.password'),
