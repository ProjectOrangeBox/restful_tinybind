...
class Blogs_model extends Database_model {
	...
	protected $rules = [
		...
		'blog_title' => ['field' => 'blog_title', 'label' => 'Title', 'rules' => 'required|filter_input'],
		'blog_description' => ['field' => 'blog_description', 'label' => 'Blog Description', 'rules' => 'filter_textarea'],
		'blog_price' => ['field' => 'blog_price', 'label' => 'Price', 'rules' => 'if_empty[0.0]|decimal|max_length[10]|less_than[4294967295]|filter_float[10]'],
